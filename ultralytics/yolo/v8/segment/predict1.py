...
def draw_boxes(img, bbox, names,object_id, identities=None, offset=(0, 0)):
    ...
    for i, box in enumerate(bbox):
        ...
        for idx, (key, value) in enumerate(object_counter1.items()):
          ...
          cv2.putText(img, f'Count of vehicles Entering', (width - 500, 35), 0, 1, [255, 0, 0], thickness=2, lineType=cv2.LINE_AA)

          cv2.putText(img, f'Total Count: ' + str(count_up), (width - 300, 75), 0, 1, [255, 0, 0], thickness=2, lineType=cv2.LINE_AA)
          cv2.putText(img, cnt_str, (width - 200, 105 + (idx*40)), 0, 1, [255, 0, 0], thickness=2, lineType=cv2.LINE_AA)

        for idx, (key, value) in enumerate(object_counter.items()):
          cnt_str1 = str(key) + ":" + str(value)
          cv2.putText(img, f'Count of vehicles Leaving', (11, 35), 0, 1, [255, 0, 0], thickness=2, lineType=cv2.LINE_AA)

          cv2.putText(img, f'Total Count: ' + str(count_down), (11, 75), 0, 1, [255, 0, 0], thickness=2, lineType=cv2.LINE_AA)
